...
const locationsData = [
  ...
  { 
    ...
    image: 'https://images.unsplash.com/photo-1568642345222-9f39572a4a2c?auto=format&fit=crop&w=800&q=80' 
  },
  { 
    id: 3, 
    name: 'Phuket', 
  ...
  { 
    ...
    image: 'https://images.unsplash.com/photo-1551574438-33a7afc9b3e6?auto=format&fit=crop&w=800&q=80' 
  },
  { 
    id: 5, 
    name: 'Hua Hin', 
    address: '129 Phetkasem Road, Hua Hin, Prachuap Khiri Khan 77110', 
    image: 'https://images.unsplash.com/photo-1565888283243-9d0315f13e6a?auto=format&fit=crop&w=800&q=80' 
  },
  { 
    id: 6, 
    name: 'Krabi', 
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {locationsData.slice(0, visibleLocations).map((location) => (
            <Card key={location.id} className="bg-dark border border-neon-blue/50 overflow-hidden rounded-lg transition-all duration-300 hover:border-neon-pink/70">
